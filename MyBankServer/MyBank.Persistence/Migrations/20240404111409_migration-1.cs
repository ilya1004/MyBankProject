...
namespace MyBank.Persistence.Migrations
{
    ...
    public partial class migration1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastDateRateUpdate = table.Column<DateTime>(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AccountSenderNumber = table.Column<string>(type: "text", nullable: true),
                    UserSenderNickname = table.Column<string>(type: "text", nullable: true),
                    AccountRecipientNumber = table.Column<string>(type: "text", nullable: true),
                    UserRecipientNickname = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasInterestWithdrawalOption = table.Column<bool>(
                        type: "boolean",
                        nullable: false
                    ),
                    UserId = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateIndex(name: "IX_Cards_UserId", table: "Cards", column: "UserId");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropTable(name: "CreditPayments");

            migrationBuilder.DropTable(name: "CreditRequests");

            migrationBuilder.DropTable(name: "DepositAccruals");

            migrationBuilder.DropTable(name: "Messages");

            migrationBuilder.DropTable(name: "Transactions");

            migrationBuilder.DropTable(name: "CardPackages");

            migrationBuilder.DropTable(name: "PersonalAccounts");

            migrationBuilder.DropTable(name: "CreditAccounts");

            migrationBuilder.DropTable(name: "DepositAccounts");

            migrationBuilder.DropTable(name: "Admins");

            migrationBuilder.DropTable(name: "Moderators");
