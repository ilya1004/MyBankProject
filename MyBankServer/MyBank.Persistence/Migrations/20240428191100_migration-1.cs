        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OperationsSum = table.Column<decimal>(type: "money", nullable: false),
                    AverageAccountBalance = table.Column<decimal>(type: "money", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastRateUpdate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    OfficialRate = table.Column<decimal>(type: "money", nullable: false),
                    CreditInterestRate = table.Column<decimal>(type: "numeric", nullable: false),
                    DepositInterestRate = table.Column<decimal>(type: "numeric", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    StartBalance = table.Column<decimal>(type: "money", nullable: false),
                    InterestRate = table.Column<decimal>(type: "numeric", nullable: false),
                    InterestCalculationType = table.Column<string>(type: "text", nullable: false),
                    CreditTermInDays = table.Column<int>(type: "integer", nullable: false),
                    TotalPaymentsNumber = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    AccrualAmount = table.Column<decimal>(type: "money", nullable: false),
                    Datetime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Status = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsOperationsAllowed = table.Column<bool>(type: "boolean", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
