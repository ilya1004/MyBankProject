...
export default function AddDepositPackagePage() {
  ...
  const addPackage = async () => {
    ...
    try {
      const res = await axiosInstance.post(`DepositPackages/Add`, data);
      showMessageStc("Пакет депозитов был успешно добавлен", "success");
      navigate("/admin/management");
    } catch (err) {
      handleResponseError(err.response);
    }
