...
const getMessagesData = async () => {
  ...
  try {
    const res = await axiosInstance.get(`Messages/GetAllInfoByCurrentAdmin`);
        ...
        txt = (
          <>
            <Flex gap={5}>
              <Flex gap={8}>
                <Link
                  to={`/admin/users/${record.senderUserId}`}
        ...
        txt = (
          <>
            <Flex gap={5}>
              ...
              <Flex gap={8}>
                <Link
                  to={`/admin/users/${record.recepientId}`}
                  component={Typography.Link}
                >
